...
class home_page:
    def __init__(self, root, user, login_database, parameter_database): 
        ...
        self.as_label = tk.Label(self.window, text="Atrial Sensitivity", font=("Raleway", 12))
        self.vs_label = tk.Label(self.window, text="Ventricular Sensitivity", font=("Raleway", 12))
...
# These commented out until the database has entries for "as", "PVARP", ... 

            # self.as_label = tk.Label(self.window, text=f'Atrial Sensitivity: {self.param_DB[dict_user]["AAI"]["as"]}', font=("Raleway", 12), width = 20, height = 1)
            # self.as_label.grid(column=5, row=6)
...
# These commented out until the database has entries for "as", "PVARP", ... 
            ...
            # self.as_label = tk.Label(self.window, text=f'Ventricular Sensitivity: {self.param_DB[dict_user]["VVI"]["as"]}', font=("Raleway", 12), width = 20, height = 1)
            # self.as_label.grid(column=5, row=6)
...
##### Commented out until have a DOO dictionary in database 
...
### Commented out until have AOOR dictionary in database 
...
### Commented out until have VOOR dictionary in database 
...
# These commented out until the database has AAIR dictionary 
